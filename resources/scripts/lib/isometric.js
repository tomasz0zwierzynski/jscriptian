...
var Isometric = {
  ...
  Xtiles: 10, // Number of tiles in X-dimension
  Ytiles: 10, // Number of tiles in Y-dimension
  ...
  run: function() {
   ...
   $(window).on('mousemove', function(e) {
     e.pageX = e.pageX - self.tileColumnOffset - self.originX + self.xxx;
     e.pageY = e.pageY - self.tileRowOffset - self.originY + self.yyy;
    ...
    $(window).on('click', function() {
      ...
      if (self.clickHandler) {
        self.clickHandler(self.selectedTileX, self.selectedTileY);
      }
    });
